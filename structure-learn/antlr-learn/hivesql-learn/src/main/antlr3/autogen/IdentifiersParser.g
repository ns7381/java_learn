...
// group by a,b
groupByClause
@init { gHiveParser.pushMsg("group by clause", state); }
...
@init {gHiveParser.pushMsg("grouping set expression", state); }
@after {gHiveParser.popMsg(state); }
   :
...
@init {gHiveParser.pushMsg("grouping set part expression", state); }
@after {gHiveParser.popMsg(state); }
   :
   LPAREN 
...
groupingExpressionSingle
@init { gHiveParser.pushMsg("groupingExpression expression", state); }
@after { gHiveParser.popMsg(state); }
    :
...
havingClause
@init { gHiveParser.pushMsg("having clause", state); }
@after { gHiveParser.popMsg(state); }
    :
...
havingCondition
@init { gHiveParser.pushMsg("having condition", state); }
@after { gHiveParser.popMsg(state); }
    :
    expression
    ;
...
// order by a,b
orderByClause
@init { gHiveParser.pushMsg("order by clause", state); }
@after { gHiveParser.popMsg(state); }
    :
...
clusterByClause
@init { gHiveParser.pushMsg("cluster by clause", state); }
@after { gHiveParser.popMsg(state); }
    :
    KW_CLUSTER KW_BY
    (
...
partitionByClause
@init  { gHiveParser.pushMsg("partition by clause", state); }
@after { gHiveParser.popMsg(state); }
    :
    KW_PARTITION KW_BY
    (
...
distributeByClause
@init { gHiveParser.pushMsg("distribute by clause", state); }
@after { gHiveParser.popMsg(state); }
    :
    KW_DISTRIBUTE KW_BY
    (
...
sortByClause
@init { gHiveParser.pushMsg("sort by clause", state); }
@after { gHiveParser.popMsg(state); }
    :
    KW_SORT KW_BY
    (
...
// fun(par1, par2, par3)
function
@init { gHiveParser.pushMsg("function specification", state); }
@after { gHiveParser.popMsg(state); }
    :
    functionName
    LPAREN
...
functionName
@init { gHiveParser.pushMsg("function name", state); }
@after { gHiveParser.popMsg(state); }
...
castExpression
@init { gHiveParser.pushMsg("cast expression", state); }
@after { gHiveParser.popMsg(state); }
    :
    KW_CAST
    LPAREN
...
caseExpression
@init { gHiveParser.pushMsg("case expression", state); }
@after { gHiveParser.popMsg(state); }
    :
    KW_CASE expression
...
constant
@init { gHiveParser.pushMsg("constant", state); }
@after { gHiveParser.popMsg(state); }
    :
    Number
    | dateLiteral
...
charSetStringLiteral
@init { gHiveParser.pushMsg("character string literal", state); }
@after { gHiveParser.popMsg(state); }
    :
...
expression
@init { gHiveParser.pushMsg("expression specification", state); }
@after { gHiveParser.popMsg(state); }
    :
...
functionIdentifier
@init { gHiveParser.pushMsg("function identifier", state); }
@after { gHiveParser.popMsg(state); }
...
principalIdentifier
@init { gHiveParser.pushMsg("identifier for principal spec", state); }
@after { gHiveParser.popMsg(state); }
    : identifier
    | QuotedIdentifier
    ;
