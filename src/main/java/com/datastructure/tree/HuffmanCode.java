...
import com.datastructure.tree.HuffmanTree.Node;
...
public class HuffmanCode {
    ...
    public Map<Byte, String> huffmanCode(Map<Byte, Integer> map) {
        ...
        Node<Byte> root = new HuffmanTree<>(map).root;
    ...
    private void huffmanCode(Node<Byte> node, String code, Map<Byte, String> huffmanCodes) {
        // 前序遍历
        if (node == null) {
            return;
        }
