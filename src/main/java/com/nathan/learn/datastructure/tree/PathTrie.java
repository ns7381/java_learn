...
public class PathTrie {
  ...
  public String findMaxPrefix(final String path) {
    ...
    try {
      ...
      System.out.println(deepestPropertyNode);
  ...
  public static void main(String[] args) {
    ...
    pathTrie.addPath("/test/dd_edw/app/t1");
    pathTrie.addPath("/test/dd_edw/app/t2");
    pathTrie.addPath("/test/dd_edw/odm/t3");
    pathTrie.addPath("/test/dd_edw/odm");
    pathTrie.addPath("/test/dd_edw/app");
    pathTrie.addPath("/test/market1");
    pathTrie.addPath("/test");
    pathTrie.addPath("/test");
    System.out.println(pathTrie.findMaxPrefix("/test/dd_edw/app/t4"));
  }
