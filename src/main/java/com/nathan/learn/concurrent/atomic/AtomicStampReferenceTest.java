package com.nathan.learn.concurrent.atomic;
...
public class AtomicStampReferenceTest {
    ...
    public static void main(String[] args) {
        ...
        Thread other = new Thread(() -> {
            ...
            System.out.println(Thread.currentThread() + ",【increment】 ,值 = " + atomicStampedRef.getReference());
            atomicStampedRef.compareAndSet(2, 1, atomicStampedRef.getStamp(), atomicStampedRef.getStamp() + 1);
            System.out.println(Thread.currentThread() + ",【decrement】 ,值 = " + atomicStampedRef.getReference());
        }, "干扰线程");
